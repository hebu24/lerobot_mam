...
# Use the same underlying train/eval trajectories as the 90k experiment, but
# retain the current four-slot train and five-slot eval mixed-mask protocol.
...
# Keep the current avg-MSE and long64 mask/model settings unchanged.
...
export JOB_NAME="${JOB_NAME:-mam_libero10_500train_100first50eval_refmix_train4_eval5_long64_avgmse_scratch_8gpu_${RUN_ID}}"
