...
TRAIN_SESSION=dp_libero10_hf_4gpu_effbs64_multirankeval_100k_20260721_214055
JOB_NAME=diffusion_libero10_v3_hf_100k_4gpu_effbs64_multirankeval_20260721_214055
...
while true; do
  {
    ...
    if [[ -n "${latest_rank_dir}" ]]; then
      ...
      find "${latest_rank_dir}" -maxdepth 1 -type f -name 'rank_*.json' -o -name 'merged.json' 2>/dev/null | sort || true
    fi
